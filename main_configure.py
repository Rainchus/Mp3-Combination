...
def parse_and_validate_args():
    ...
    if args.mk64:
        extra_games.append("mp1")  # Ensure mp1 is added first
...
.open "rom/{combinedBaseromName}", "rom/{combinedRomModName}", 0 // Open the ROM file
"""
...
def create_ninja_file(combinedRomModName, combinedBaseromName):
    ...
    with open('build.ninja', 'w') as buildfile:
        ...
        ninja.rule(
            ...
            description=f"Running n64crc.exe on {combinedRomModName}"
        )
...
if __name__ == "__main__":
    #print(sys.argv[1:]) print args
    combinedName = parse_and_validate_args()
    combinedBaseromName = combinedName + ".z64"
    combinedRomModName = combinedName + ".mod.z64"
