...
/* 0x4E */ GrabBagStr,
/* 0x4F */ LavaTileIsleStr,
/* 0x50 */ BumperBalloonCarsStr,
/* 0x51 */ RakinEmInStr,
...
DEBUG_RAINBOW_RUN
DEBUG_CRANE_GAME
DEBUG_MOVE_TO_THE_MUSIC
DEBUG_BOB_OMB_BARRAGE
DEBUG_LOOK_AWAY
DEBUG_SHOCK_DROP_OR_ROLL
//page 3
DEBUG_LIGHTS_OUT
DEBUG_FILET_RELAY
DEBUG_ARCHER_IVAL
DEBUG_TOAD_BANDSTAND
DEBUG_BOBSLED_RUN
DEBUG_HANDCAR_HAVOC
DEBUG_BALLOON_BURST
DEBUG_SKY_PILOTS
...
DEBUG_CRAZY_CUTTERS
DEBUG_TOAD_IN_A_BOX
DEBUG_MECHA_MARATHON
DEBUG_ROLL_CALL
DEBUG_ABANDON_SHIP
DEBUG_PLATFORM_PERIL
DEBUG_TOTEM_POLE_POUND
DEBUG_BUMPER_BALLS
DEBUG_BOMBS_AWAY
DEBUG_TIPSY_TOURNEY
DEBUG_HONEYCOMB_HAVOC
DEBUG_HEXAGON_HEAT
DEBUG_SKATEBOARD_SCAMPER
DEBUG_SLOT_CAR_DERBY
DEBUG_SHY_GUY_SAYS
DEBUG_SNEAK_N_SNORE
DEBUG_DRIVERS_ED
DEBUG_CHANCE_TIME
//for these, set mode to board or it will crash!
DEBUG_WESTERN_LAND_DUEL
DEBUG_PIRATE_LAND_DUEL
DEBUG_HORROR_LAND_DUEL
DEBUG_SPACE_LAND_DUEL
DEBUG_MYSTERY_LAND_DUEL
DEBUG_KOOPA_LAND_DUEL
//back to normal minigames
DEBUG_LOONEY_LUMBERJACKS
DEBUG_DIZZY_DANCING
DEBUG_TILE_DRIVER
DEBUG_QUICKSAND_CACHE
DEBUG_BOWSERS_BIG_BLAST
DEBUG_TORPEDO_TARGETS
DEBUG_DESTRUCTION_DUET
DEBUG_DEEP_SEA_SALVAGE
*/
};
