...
// extern s32 mp2_D_800CD2C4_CDEC4;
// extern s16 mp2_D_800F93C8_F9FC8;

// void LoadMinigameFromBoot3(void) {
//     mp2_func_800794A8(0x28);
//     //TODO: copy debug players to gPlayers on this line ( func_80105C50_D8C40(); )
//     D_800F93C8 = ovl_table_custom[mp2_MinigameIndexToLoad].overlayID;
//     D_800F93C6 = 0;
//     if (((mp2_debugMode == 0) | (mp2_debugMode == 2)) != 0) {
//         if (mp2_debugMode == 0) {
//             mp2_func_800683BC_68FBC(0xC);
//         } else {
//             mp2_func_8006836C_68F6C(0xC);
//         }
//         mp2_omOvlCallEx(func_8003F6F0_402F0(D_800F93C8), 0, 0x92);
//         return;
//     }
//     // if (mp2_debugMode == 1) {
//     //     func_800683BC_68FBC(0xC);
//     //     omOvlCallEx(*(&D_80105E54 + (((D_801072A0 * 0xA) + D_801072A2) * 0x10)), 0, 0x92);
//     // }
// }


// // void LoadMinigameFromBoot3() {
// //     //mp2_func_8006836C_68F6C(0xE); //_SetFlag
// //     mp2_D_800CD2C4_CDEC4++;
// //     mp2_func_80067E6C_68A6C(0x27);
// //     mp2_omOvlCallEx(mp2_D_800F93C8_F9FC8, 0, 0x94);
...
//         func_800683BC_68FBC(0xC); //?
//         mp2_omOvlCallEx(D_800F93C8, 0, 0x84); //gets explanation screen
//         check = 1;
//         return;
//     }
// }
