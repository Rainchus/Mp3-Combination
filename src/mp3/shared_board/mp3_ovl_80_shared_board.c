...
void func_800F6BC4_10A7E4_shared_board(s32 arg0) {
    ...
    for (i = 0; i < MAX_PLAYERS; i++) {
        if (arg0 == CUR_PLAYER || arg0 == i) {
            ...
            if (temp_s2->uiUpdatePaused == TRUE) {
                ...
                mp3_func_80054904_55504(temp_s2->playerIndex, 1, PlayerIconPositions[1][0], PlayerIconPositions[1][1]);
    ...
    for (var_f20 = 0.0f; var_f20 <= 90.0f; var_f20 += 15.0f) {
        for (i = 0; i < MAX_PLAYERS; i++) {
            if (arg0 == CUR_PLAYER || arg0 == i) {
                mp3_func_800F6AD0_10A6F0_shared_board(i, mp3_HuMathCos(var_f20), 1.0f);
            }            
        }
        mp3_HuPrcVSleep();
    }
    for (i = 0; i < MAX_PLAYERS; i++) {
        if (arg0 == CUR_PLAYER || arg0 == i) {
            mp3_func_800F6AD0_10A6F0_shared_board(i, 0.0f, 0);
        }
    }
    mp3_HuPrcVSleep();
}
    ...
    while (1) {
        if (D_800D20B1_D2CB1 == 0) {
                ...
                if (temp_s2->uiUpdatePaused == FALSE) {
                    ...
                    for (k = 0; k < iconLoopCount; k++) {
                        ...
                        case 15:
                            ...
                            mp3_func_80054904_55504(temp_s2->playerIndex, k, PlayerIconPositions[var_v1][0], PlayerIconPositions[var_v1][1]);
                            mp3_SprAttrSet(temp_s2->playerIndex, k, 0x8000);
            ...
            if (D_801055C2_1191E2_shared_board != -1) {
                ...
                mp3_SprScale(D_801055C2_1191E2_shared_board, 0, D_801055C8_1191E8_shared_board, D_801055C8_1191E8_shared_board);
...
void newfunc_800F3FF4_107C14_shared_board(s32 arg0) {
    ...
    for (i = 0; i < itemCount; i++) {
        ...
        mp3_func_80054904_55504(temp_s3, i + 0xB, PlayerIconPositions[var_s1][0], PlayerIconPositions[var_s1][1]);
...
void newfunc_800F6ECC_10AAEC_shared_board(s32 arg0) {
    ...
    for (i = 0; i < MAX_PLAYERS; i++) {
        if (arg0 == CUR_PLAYER || arg0 == i) {
            mp3_func_800F6AD0_10A6F0_shared_board(i, 1.0f, 1.0f);
            temp_s2 = &D_801057E0_119400_shared_board[i];
            if (temp_s2->uiUpdatePaused == TRUE) {
...
void newfunc_800F6AD0_10A6F0_shared_board(s32 arg0, f32 xScale, f32 yScale) {
    ...
    case FALSE:
        for (i = 0; i < baseIconOffset + itemCount; i++) {
            mp3_SprScale(temp_s1->playerIndex, i, xScale, yScale);
        }
        break;
    case TRUE:
        ...
        mp3_SprScale(temp_s1->playerIndex, 9, xScale, yScale);
        break;
    }
}
...
void newfunc_800F5F98_109BB8_shared_board(s32 arg0, s32 arg1) {
    ...
    for (i = 0; i < itemCount; i++) {
        var_s2 = NULL;
        if (mp3_GwPlayer[temp].itemNo[i] != -1) {
        ...
        if (var_s2 != NULL) {
            ...
            mp3_SprScale(temp_s5, i + 2, 1.0f, 1.0f);
