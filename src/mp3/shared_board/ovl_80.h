...
mp3_Object* func_800D90C8_ECCE8_shared_board(u8, s32);
void func_800D9714_ED334_shared_board(mp3_Object*);
...
s32 mp3_BoardPlayerRankCalc(s32 player);
void newUpdatePlayerBoardStatus(s32, s32);
void mp3_func_800F6A88_10A6A8_shared_board(s16, u16);
void newfunc_800F6AD0_10A6F0_shared_board(s32, f32, f32);
...
void mp3_func_800F3A80_1076A0_shared_board(s32);
void mp3_func_800F3BD0_1077F0_shared_board(s32);
void mp3_func_800F3E34_107A54_shared_board(s32);
void mp3_func_800F3FF4_107C14_shared_board(s32);
void mp3_func_800F5F98_109BB8_shared_board(s32, s32);
void mp3_func_800F6AA4_10A6C4_shared_board(s16 arg0, s16 arg1);
...
void mp3_func_800F5BF4_109814_shared_board(s32, s32, s32);
void mp3_func_800F3D70_107990_shared_board(s32);
void mp3_func_800F3F0C_107B2C_shared_board(s32);
void mp3_SprAttrSet(s16, s16, u16);
void mp3_SprAttrReset(s16, s16, u16);
void mp3_func_80055140_55D40(s32, s16, u16, s32);
void mp3_func_800550F4_55CF4(s16, s16, s32);
void mp3_func_800550B4_55CB4(s32, s16, f32);
void mp3_func_80055024_55C24(s16, s16, s16, s32);
void mp3_SprPriSet(s16, s16, u16);
void mp3_func_80054904_55504(s16, s16, s16, s16);
void UpdatePlayerBoardStatus(s32);
void mp3_HuSprScaleSet(s16, s16, f32, f32);
void mp3_func_800552DC_55EDC(s16, s16, f32);
void mp3_func_80055458_56058(s16, s16, u16);
void mp3_func_80055420_56020(s16, s32, u8, u8, s32);
void mp3_func_800E1934_F5554_shared_board(s32, s32);
void mp3_func_800F59B4_1095D4_shared_board(mp3_omObjData* arg0);
s16 mp3_func_8005279C_5339C(s32, s32);
void mp3_func_800F696C_10A58C_shared_board(s32 arg0, s32 arg1, f32 arg2, f32 arg3);
...
s32 mp3_func_800F52C4_108EE4_shared_board(void);
...
extern s16 PlayerIconPositions[31][2];
...
extern s16 mp3_PlayerBoardStatusRootPosition[23][2];
...
extern mp3_Process* D_80105580_1191A0_shared_board;
...
extern mp3_omObjData* mp3_D_801055E8_119208_shared_board[];
